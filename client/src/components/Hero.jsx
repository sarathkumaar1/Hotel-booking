...
const Hero = () => {
  ...
  return (
    ...
    px-6 md:px-16 lg:px24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")]
    bg-no-repeat bg-cover bg-center h-screen'>
      ...
      [56px] font-bold md:font md:font-extrabold max-w-xl mt-4'>Dicover Your Perfect Gateway Destination</h1>
      <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalled luxury and comfort await at the world's most exclusive 
