...
const HotelReg = () => {
  ...
  return (
    ...
    justify-center bg-black/70'>
        ...
        className='flex bg-white rounded-xl max-w-4xl max:mx-2'>
            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                ...
                <div className='w-full mt-4'>
                    ...
                    id='contact' type="number" placeholder='type here' className='border
                    border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500
                    font-light' required/>
                </div>
                {/* Address */}
                <div className='w-full mt-4'>
                    ...
                    id='address' type="text" placeholder='type here' className='border
                    border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500
                    font-light' required/>
                </div>
