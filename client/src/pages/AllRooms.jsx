...
const AllRooms = () => {
    ...
    //finction to check if a room matches the selected the selected price ranges
    ...
    // Filter sort rooms based on the selected filters and sort option
    const filteredRooms = useMemo(()=>{
        return rooms.filter(room => matchesRoomTypes(room) && matchesPriceRange
       ...
       <div>
        ...
        {filteredRooms.map((room)=>(
            ...
            border-b border-gray-300 last:pb-30 last:border-0'>
                ...
                src={room.images[0]} alt="hotel-img" title='View Room
                Details' className='max-h-65 md:w-1/2 rounded-xl shadow-lg object-cover
                cursor-pointer'/>
