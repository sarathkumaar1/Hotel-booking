...
const RoomDetails = () => {
    ...
    //check if the Room is availbale
    const checkAvailability = async ()=>{
        try {
            // check is check-In Date is greater that check-out Date
            if(checkInDate >= checkOutDate){
                toast.error('Check-In Date should be less that Check-Out Date')
                return;
            }
  ...
  return room && (
        ...
        rounded-xl mx-auto mt-16 max-w-6xl'>
            ...
            md:items-center gap-4 md:gap-10 text-gray-500'>
                ...
                <div className='flex flex-col'>
                    ...
                    type="date" id='checkOutDate' className='w-full rounded border border-gray-300
                    px-3 py-2 mt-1.5 outline-none' required/>
                </div>
                <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
                <div className='flex flex-col'>
    ...
    <div className='flex flex-col items-start gap-4'>
        ...
        <button className='px-6 py-2.5 mt-4 rounded text-white bg-blue-500
