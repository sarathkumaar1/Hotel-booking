...
const MyBookings = () => {
  ...
  return (
    <div  className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        and upcoming hotel reservation in one place,Plan your trips seamlessly with
        ...
        <div className='max-w-6xl mt-8 w-full text-gray-800'>
            ...
            {bookings.map((booking)=>(
                ...
                {/* date & timings */}
                <div className='flex flex-col md:items-center md:gap-12 mt-3 gap-8'>
                    <div>
                        <p>Check-In:</p>
                ...
                {/* payment status */}
                <div className='grid grid-row items-start  pt-3'>
